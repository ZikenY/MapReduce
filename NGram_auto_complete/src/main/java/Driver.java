...
public class Driver {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException, InterruptedException {
        ...
        // use dbOutputformat to define the table_name and columns
        String tablename = "output";
        String[] columns = new String[] {"starting_phrase", "following_word", "count"};
        DBOutputFormat.setOutput(job2, tablename, columns);
